      ...
      if(ptot<100){
        ...
        do {
          ...
          if ( roll == 1 ) {
            ...
            if ( turnTotal < 20 && (ctot+turnTotal<100)) {// modified line for study drill. Add && (ctot+turnTotal<100)".
              System.out.println( "\tComputer will roll again." );
          }
        }
      } while (roll != 1 && turnTotal < 20 && (ctot+turnTotal<100));  //modified line for study drill
